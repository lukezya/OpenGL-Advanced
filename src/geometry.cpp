...
//for bounding boxes
float GeometryData::getMinX() const{
	return minX;
}

float GeometryData::getMinY() const {
	return minY;
}

float GeometryData::getMinZ() const {
	return minZ;
}

float GeometryData::getMaxX() const {
	return maxX;
}

float GeometryData::getMaxY() const {
	return maxY;
}

float GeometryData::getMaxZ() const {
	return maxZ;
}

float GeometryData::getCentreX() const {
	return -(maxX + minX) / 2;
}

float GeometryData::getCentreY() const {
	return -(maxY+minY)/2;
}

float GeometryData::getCentreZ() const {
	return -(maxZ + minZ) / 2;
}

int GeometryData::getNormalCount() {
	return normals.size();
}

int GeometryData::getTextureCount() {
	return textureCoords.size();
}

int GeometryData::getTangentCount() {
	return tangents.size();
}

int GeometryData::getBitangentCount() {
